...
public interface ProjectScheduleMapper extends BaseMapper<ProjectSchedule> {
    ...
    IPage<ProjectSchedule> findAll(@Param("criteria") ProjectScheduleQueryCriteria criteria, Page<Object> page);

    List<ProjectSchedule> findAll(@Param("criteria") ProjectScheduleQueryCriteria criteria);
}