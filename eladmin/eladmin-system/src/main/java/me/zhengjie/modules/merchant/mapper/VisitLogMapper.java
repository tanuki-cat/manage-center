...
public interface VisitLogMapper extends BaseMapper<VisitLog> {
    ...
    IPage<VisitLog> findAll(@Param("criteria") VisitLogQueryCriteria criteria, Page<Object> page);

    List<VisitLog> findAll(@Param("criteria") VisitLogQueryCriteria criteria);
}