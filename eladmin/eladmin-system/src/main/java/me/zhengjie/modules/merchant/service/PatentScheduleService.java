...
* @date 2024-01-02
**/
public interface PatentScheduleService extends IService<PatentSchedule> {
    ...
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<PatentScheduleDto>
    */
    List<PatentSchedule> queryAll(PatentScheduleQueryCriteria criteria);

    /**
    * 创建
    * @param resources /
    */
    void create(PatentSchedule resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(PatentSchedule resources);
