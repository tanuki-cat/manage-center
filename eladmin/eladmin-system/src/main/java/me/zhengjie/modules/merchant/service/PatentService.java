...
public interface PatentService extends IService<Patent> {
    ...
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<PatentDto>
    */
    List<Patent> queryAll(PatentQueryCriteria criteria);

    /**
    * 创建
    * @param resources /
    */
    void create(Patent resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(Patent resources);
    ...
    * @throws IOException /
    */
    void download(List<Patent> all, HttpServletResponse response) throws IOException;
}