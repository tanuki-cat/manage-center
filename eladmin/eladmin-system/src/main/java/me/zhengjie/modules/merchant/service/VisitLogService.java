...
public interface VisitLogService extends IService<VisitLog> {
    ...
    * @return PageResult
    */
    PageResult<VisitLog> queryAll(VisitLogQueryCriteria criteria, Page<Object> page);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<VisitLogDto>
    */
    ...
    * @param resources /
    */
    void create(VisitLog resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(VisitLog resources);
    ...
    * @throws IOException /
    */
    void download(List<VisitLog> all, HttpServletResponse response) throws IOException;
}